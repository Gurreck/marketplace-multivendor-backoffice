...
const CardPay = ({
    ...
    const logos = {
      ...
      AMEX: (
        <svg viewBox="0 0 48 32" width="50" height="34">
          ...
          <path
            d="M8 12h4l1 2.5 1-2.5h4v7h-3v-4.5l-1.5 3.5h-2l-1.5-3.5v4.5h-3v-7zm14 0h8v2h-5v.5h4.5v2h-4.5v.5h5v2h-8v-7zm10 0h3l2 3.5 2-3.5h3v7h-3v-4l-2 3.5h-2l-2-3.5v4h-3v-7z"
            fill="#fff"
          />
        </svg>
      ),
      DISCOVER: (
        <svg viewBox="0 0 48 32" width="50" height="34">
          ...
          <text x="10" y="20" fill="#fff" fontSize="8" fontWeight="bold">
            DISCOVER
          </text>
        </svg>
      ),
  ...
  const handleSubmit = async (e) => {
    ...
    if (!token || token === "undefined" || token === "null")
      newErrors.general = "Sesión expirada. Inicia sesión nuevamente";
    ...
    <>
      <div className={`pasarela-de-pago ${!isDarkMode ? "modo-claro" : ""}`}>
        <h2 className="titulo-pago-pasarela">
          <CreditCard size={24} style={{ marginRight: "10px" }} /> Completar
          Pago
        </h2>
        ...
        {generalError && (
          <div className="error-general-pago">{generalError}</div>
        )}
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="formulario-pago-pasarela">
            ...
            {errors.cvv && (
              <span className="mensaje-error-pasarela">{errors.cvv}</span>
            )}
            {errors.cardName && (
              <span className="mensaje-error-pasarela">{errors.cardName}</span>
            )}
          </div>
        ...
        <div className="seccion-confianza-pasarela">
          <p className="texto-pago-seguro-pasarela">
            <Lock size={14} style={{ marginRight: "8px" }} /> Pagos encriptados
            y seguros
          </p>
        ...
        <div className={`capa-modal-exito-pasarela ${!isDarkMode ? "modo-claro" : ""}`}>
          <div className={`modal-exito-pasarela ${!isDarkMode ? "modo-claro" : ""}`}>
            ...
            <div className="detalles-modal-exito-pasarela">
              <p className="mensaje-exito-pasarela">
              ...
              <div className="info-tarjeta-modal-pasarela">
                <div className="fila-info-modal-pasarela">
                  ...
                  <span className="valor-modal-pasarela">
                    {maskedCardDisplay} ********
                  </span>
                </div>
                <div className="fila-info-modal-pasarela">
              ...
              {address && (
                <div className="info-direccion-modal-pasarela">
                  <div className="fila-info-modal-pasarela">
                    <span className="etiqueta-modal-pasarela">
                      Dirección de envío
                    </span>
                  </div>
