...
const PaymentGateway = () => {
  ...
  const validateAddress = () => {
    ...
    if (!address.direccion.trim())
      newErrors.direccion = "La dirección exacta es requerida";
    return newErrors;
  };
  ...
  const detectCardType = (number) => {
    ...
    if (
      ...
      /^622(12[6-9]|1[3-9]\d|[2-8]\d{2}|91\d|92[0-5])/.test(cleanNumber)
    )
      return "DISCOVER";
    if (/^3[068]/.test(cleanNumber) || /^30[0-5]/.test(cleanNumber))
      return "DINERS";
          ...
          <div className="diseno-dos-columnas-pasarela">
            <div className="columna-izquierda-pasarela">
              <div className="direccion-envio">
                <h3 className="titulo-direccion-pasarela">
                  <MapPin size={20} style={{ marginRight: "10px" }} /> Dirección
                  de envío
                </h3>
              ...
              <div className="resenas-en-direccion-pasarela">
                <h3 className="titulo-resenas-pasarela">
                ...
                <div className="lista-productos-resenas-pasarela">
                  {selectedItems.map((item, index) => (
                    <div
                      ...
                      className="tarjeta-producto-resena-pasarela"
                    >
                      <img
                        src={
                          item.images?.[0]?.url ||
                      ...
                      <div className="info-producto-resena-pasarela">
                        <span className="nombre-producto-resena-pasarela">
                          {item.name}
                        </span>
                        <button
            ...
            <div className="columna-derecha-pasarela">
              <div className="pasarela-de-pago">
                ...
                <form onSubmit={handleSubmit}>
                  <div
                    className={`vista-previa-tarjeta-pasarela ${cardType ? cardType.toLowerCase() : ""}`}
                  >
...
const PaymentGateway = () => {
    ...
    return (
            ...
            <div className={`contenedor-pasarela ${!isDarkMode ? 'modo-claro' : ''}`}>
                <div className="contenido-principal-pasarela">
                  ...
                  <div className="formulario-pago-pasarela">
                    ...
                    {errors.cardNumber && (
                      <span className="mensaje-error-pasarela">
                        {errors.cardNumber}
                      </span>
                    )}
                    {errors.expiryDate && (
                ...
                <div className="seccion-confianza-pasarela">
                  <p className="texto-pago-seguro-pasarela">
                    <Lock size={14} style={{ marginRight: "8px" }} /> Pagos
        ...
        {showCommentsModal && (
          <div
            className="capa-modal-comentarios-pasarela"
            onClick={() => setShowCommentsModal(false)}
          >
            <div
              className="modal-comentarios-pasarela"
            ...
            >
                ...
                <div className="info-producto-modal-comentarios-pasarela">
                  ...
                  <div>
                    ...
                    <div className="calificacion-modal-comentarios-pasarela">
                      <span className="numero-calificacion-pasarela">
                        {selectedProductInfo?.averageRating || "0"}
                      </span>
                      ...
                      <span className="conteo-calificacion">
                        ({selectedProductInfo?.totalComments || 0})
                      </span>
                    </div>
                  </div>
                </div>
                <button
                  className="cerrar-modal-pasarela"
                  onClick={() => setShowCommentsModal(false)}
                >
                  <X size={20} />
                </button>
              ...
              <div className="cuerpo-modal-comentarios-pasarela">
                {loadingProductComments ? (
                  <div className="cargando-comentarios-pasarela">
                    <Loader2 className="animacion-giro" />
                  </div>
                          ...
                          <div className="calificacion-comentario-pasarela">
                            {[...Array(5)].map((_, i) => (
                              <Star
                                ...
                                color={i < comment.rating ? "#fbbf24" : "#ccc"}
                              />
                            ))}
                          </div>
                        </div>
                        <p className="texto-comentario-pasarela">
                          {comment.text}
                        </p>
                      </div>
                    ))}
            ...
            <div className="modal-exito-pasarela">
              ...
              <div className="detalles-modal-exito-pasarela">
                ...
                <div className="tarjeta-modal-exito-pasarela">
                  ...
                  <span>
                    Total pagado: ₡{selectedSubtotal.toLocaleString()}
                  </span>
                </div>
              </div>
              <button
